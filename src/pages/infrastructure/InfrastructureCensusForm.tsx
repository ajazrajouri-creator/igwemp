...
import { Upload, Save, Send, AlertTriangle, Building, Droplets, Zap, Camera, Map, Home, BookOpen, User } from 'lucide-react';
...
function EvidenceCard({ title, metricKey, isUploaded, onUpload }: { title: string, metricKey: string, isUploaded: boolean, onUpload: () => void }) {
  return (
